...
| 3 | Load cell ADC | 1 | HX711 24-bit ADC | The board used in the prototype is roughly 24 x 16 mm. |
| 4 | Touch sensor | 1 | TTP223 capacitive touch sensor | The board used in the prototype is roughly 11 x 15 mm. |
...
| 6 | Battery | 1 | 502030 3.7 V LiPo | Connector type varies by supplier; source a matching connector to solder to the ESP32 accordingly. Check polarity before connecting: reversing it can damage the board. |
